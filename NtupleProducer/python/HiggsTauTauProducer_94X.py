...
execfile(PyFilePath+"python/triggers_94X_test.py")
...
if COMPUTEQGVAR:
   ...
   # process.QGTagger.srcJets          = cms.InputTag("updatedPatJetsUpdatedJEC")    # Could be reco::PFJetCollection or pat::JetCollection (both AOD and miniAOD)
    process.QGTagger.srcJets          = cms.InputTag("jets")
    process.QGTagger.jetsLabel        = cms.string("QGL_AK4PFchs")        # Other options: see https://twiki.cern.ch/twiki/bin/viewauth/CMS/QGDataBaseVersion
    #process.QGTagger.srcVertexCollection = cms.InputTag("offlineSlimmedPrimaryVertices") #CMP
    process.QGTagger.srcVertexCollection = cms.InputTag("vertices")
    #process.QGTagger.useQualityCuts = cms.bool(False) #CMP
