...
process.electrons = cms.Sequence(process.softElectrons)#process.bareSoftElectrons
...
process.HTauTauTree = cms.EDAnalyzer("HTauTauNtuplizer",
                      ...
                      #PUPPImetCollection = cms.InputTag("slimmedMETsPuppi"), #FRA January2019
                      #srcPFMETCov = cms.InputTag("METSignificance", "METCovariance"), #FRA January2019
                      #srcPFMETSignificance = cms.InputTag("METSignificance", "METSignificance"), #FRA January2019
