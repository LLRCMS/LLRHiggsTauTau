...
namespace LeptonIsoHelper {
  ...
  std::pair<float,float> miniRelIso_ChargedNeutral(const reco::Candidate* cand, const std::vector<const pat::PackedCandidate *> pfCands_charged, const std::vector<const pat::PackedCandidate *> pfCands_neutral, float rho, int lep_setup);
