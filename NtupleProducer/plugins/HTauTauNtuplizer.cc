...
class HTauTauNtuplizer : public edm::EDAnalyzer {
 ...
 private:
  ...
  Int_t   _lheNOutB;
  Int_t   _lheNOutC;
  std::vector<Float_t> _lhePartons_px;
  std::vector<Float_t> _lhePartons_py;
  std::vector<Float_t> _lhePartons_pz;
  std::vector<Float_t> _lhePartons_e;
  std::vector<Int_t>   _lhePartons_PdgId;
  Float_t _npu;
  ...
  static const int ntauIds = 35; //79
  ...
  std::vector<Float_t> _daughters_ecalEnergyErrPreCorr;
  std::vector<Float_t> _daughters_ecalEnergyErrPostCorr;
  std::vector<Float_t> _daughters_ecalTrkEnergyPreCorr;
  std::vector<Float_t> _daughters_ecalTrkEnergyErrPreCorr;
  std::vector<Float_t> _daughters_ecalTrkEnergyPostCorr;
  std::vector<Float_t> _daughters_ecalTrkEnergyErrPostCorr;
  std::vector<Float_t> _daughters_energyScaleValue;
  std::vector<Float_t> _daughters_energySigmaValue;
  std::vector<Float_t> _daughters_energySmearNrSigma;
  std::vector<Float_t> _daughters_energyScaleUp;
  std::vector<Float_t> _daughters_energyScaleDown;
  std::vector<Float_t> _daughters_energyScaleStatUp;
  std::vector<Float_t> _daughters_energyScaleStatDown;
  std::vector<Float_t> _daughters_energyScaleSystUp;
  std::vector<Float_t> _daughters_energyScaleSystDown;
  std::vector<Float_t> _daughters_energyScaleGainUp;
  std::vector<Float_t> _daughters_energyScaleGainDown;
  std::vector<Float_t> _daughters_energyScaleEtUp;
  std::vector<Float_t> _daughters_energyScaleEtDown;
  std::vector<Float_t> _daughters_energySigmaUp;
  std::vector<Float_t> _daughters_energySigmaDown;
  std::vector<Float_t> _daughters_energySigmaPhiUp;
  std::vector<Float_t> _daughters_energySigmaPhiDown;
  std::vector<Float_t> _daughters_energySigmaRhoUp;
  std::vector<Float_t> _daughters_energySigmaRhoDown;  
  ...
  std::vector<Float_t> _daughters_jetBTagDeepJet;
...
void HTauTauNtuplizer::Initialize(){
  ...
  _daughters_ecalEnergyErrPreCorr.clear();
  _daughters_ecalEnergyErrPostCorr.clear();
  _daughters_ecalTrkEnergyPreCorr.clear();
  _daughters_ecalTrkEnergyErrPreCorr.clear();
  _daughters_ecalTrkEnergyPostCorr.clear();
  _daughters_ecalTrkEnergyErrPostCorr.clear();
  _daughters_energyScaleValue.clear();
  _daughters_energySigmaValue.clear();
  _daughters_energySmearNrSigma.clear();
  _daughters_energyScaleUp.clear();
  _daughters_energyScaleDown.clear();
  _daughters_energyScaleStatUp.clear();
  _daughters_energyScaleStatDown.clear();
  _daughters_energyScaleSystUp.clear();
  _daughters_energyScaleSystDown.clear();
  _daughters_energyScaleGainUp.clear();
  _daughters_energyScaleGainDown.clear();
  _daughters_energyScaleEtUp.clear();
  _daughters_energyScaleEtDown.clear();
  _daughters_energySigmaUp.clear();
  _daughters_energySigmaDown.clear();
  _daughters_energySigmaPhiUp.clear();
  _daughters_energySigmaPhiDown.clear();
  _daughters_energySigmaRhoUp.clear();
  _daughters_energySigmaRhoDown.clear();
  ...
  _lheNOutB=0;
  _lheNOutC=0;
  _lhePartons_px.clear();
  _lhePartons_py.clear();
  _lhePartons_pz.clear();
  _lhePartons_e.clear();
  _lhePartons_PdgId.clear();
  _npu=0.;
...
void HTauTauNtuplizer::beginJob(){
  ...
  myTree->Branch("daughters_ecalTrkEnergyErrPreCorr",&_daughters_ecalTrkEnergyErrPreCorr);
  ...
  myTree->Branch("daughters_energyScaleValue",&_daughters_energyScaleValue);
  myTree->Branch("daughters_energySigmaValue",&_daughters_energySigmaValue);
  myTree->Branch("daughters_energySmearNrSigma",&_daughters_energySmearNrSigma);
  ...
  myTree->Branch("daughters_energyScaleStatUp",&_daughters_energyScaleStatUp);
  myTree->Branch("daughters_energyScaleStatDown",&_daughters_energyScaleStatDown);
  myTree->Branch("daughters_energyScaleSystUp",&_daughters_energyScaleSystUp);
  myTree->Branch("daughters_energyScaleSystDown",&_daughters_energyScaleSystDown);
  myTree->Branch("daughters_energyScaleGainUp",&_daughters_energyScaleGainUp);
  myTree->Branch("daughters_energyScaleGainDown",&_daughters_energyScaleGainDown);
  myTree->Branch("daughters_energyScaleEtUp",&_daughters_energyScaleEtUp);
  myTree->Branch("daughters_energyScaleEtDown",&_daughters_energyScaleEtDown);
  ...
  myTree->Branch("daughters_energySigmaPhiUp",&_daughters_energySigmaPhiUp);
  myTree->Branch("daughters_energySigmaPhiDown",&_daughters_energySigmaPhiDown);
  myTree->Branch("daughters_energySigmaRhoUp",&_daughters_energySigmaRhoUp);
  myTree->Branch("daughters_energySigmaRhoDown",&_daughters_energySigmaRhoDown);
  ...
  if(theisMC){
    ...
    myTree->Branch("lhePartons_px", &_lhePartons_px);
    myTree->Branch("lhePartons_py", &_lhePartons_py);
    myTree->Branch("lhePartons_pz", &_lhePartons_pz);
    myTree->Branch("lhePartons_e", &_lhePartons_e);
    myTree->Branch("lhePartons_PdgId", &_lhePartons_PdgId);
  ...
  myTree->Branch("daughters_jetBTagDeepJet",&_daughters_jetBTagDeepJet);
    ...
    if (lheEventProduct.isValid())
    {
      ...
      for ( size_t idxParticle = 0; idxParticle < numParticles; ++idxParticle ) {
        ...
        if( status == 1 ){
           ...
           float px    = lheParticles[idxParticle][0];
           float py    = lheParticles[idxParticle][1];
           float pz    = lheParticles[idxParticle][2];
           float e     = lheParticles[idxParticle][3];
           
           _lhePartons_px.push_back(px);
           _lhePartons_py.push_back(py);
           _lhePartons_pz.push_back(pz);
           _lhePartons_e.push_back(e);
           _lhePartons_PdgId.push_back(PdgId);
           //std::cout<<"px "<<px<<",py "<<py<<",pz "<<pz<<",e "<<e<<",pdg "<<PdgId<<std::endl;
        }
...
void HTauTauNtuplizer::FillSoftLeptons(const edm::View<reco::Candidate> *daus,
  ...
  for(edm::View<reco::Candidate>::const_iterator daui = daus->begin(); daui!=daus->end();++daui){
    ...
    float ecalEnergyErrPreCorr = -999.,  ecalEnergyErrPostCorr = -999.,  ecalTrkEnergyPreCorr = -999.,  ecalTrkEnergyErrPreCorr = -999.,  ecalTrkEnergyPostCorr = -999.,  ecalTrkEnergyErrPostCorr = -999.,  energyScaleValue = -999.,  energySigmaValue = -999.,  energySmearNrSigma = -999.,  energyScaleUp = -999.,  energyScaleDown = -999.,  energyScaleStatUp = -999.,  energyScaleStatDown = -999.,  energyScaleSystUp = -999.,  energyScaleSystDown = -999.,  energyScaleGainUp = -999.,  energyScaleGainDown = -999.,  energyScaleEtUp = -999.,  energyScaleEtDown = -999.,  energySigmaUp = -999.,  energySigmaDown = -999.,  energySigmaPhiUp = -999.,  energySigmaPhiDown = -999.,  energySigmaRhoUp = -999.,  energySigmaRhoDown = -999.;
    float corr_ele=-999.,pt_corr=-999.,E_corr=-999;
    ...
    float byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017=-1,byIsolationMVArun2017v2DBoldDMwLTraw2017=-1;
    ...
    float jetBTagCSV=-1., jetBTagDeepCSV=-1., jetBTagDeepJet=-1.;
    ...
    if(type==ParticleType::MUON){	
      ...
      std::pair<float,float> miniRelIso = LeptonIsoHelper::miniRelIso_ChargedNeutral(cand, pfCands_charged, pfCands_neutral, rho_miniRelIso, thelep_setup);
      ...
      jetBTagDeepJet = closest_jet.bDiscriminator("pfDeepFlavourJetTags:probb") + closest_jet.bDiscriminator("pfDeepFlavourJetTags:probbb") + closest_jet.bDiscriminator("pfDeepFlavourJetTags:problepb");
      ...
      ecalEnergyErrPreCorr = userdatahelpers::getUserFloat(cand,"ecalEnergyErrPreCorr");
      ecalEnergyErrPostCorr = userdatahelpers::getUserFloat(cand,"ecalEnergyErrPostCorr");
      ecalTrkEnergyPreCorr = userdatahelpers::getUserFloat(cand,"ecalTrkEnergyPreCorr");
      ecalTrkEnergyErrPreCorr = userdatahelpers::getUserFloat(cand,"ecalTrkEnergyErrPreCorr");
      ...
      energyScaleValue = userdatahelpers::getUserFloat(cand,"energyScaleValue");
      energySigmaValue = userdatahelpers::getUserFloat(cand,"energySigmaValue");
      energySmearNrSigma = userdatahelpers::getUserFloat(cand,"energySmearNrSigma");
      ...
      energyScaleStatUp = userdatahelpers::getUserFloat(cand,"energyScaleStatUp");
      energyScaleStatDown = userdatahelpers::getUserFloat(cand,"energyScaleStatDown");
      energyScaleSystUp = userdatahelpers::getUserFloat(cand,"energyScaleSystUp");
      energyScaleSystDown = userdatahelpers::getUserFloat(cand,"energyScaleSystDown");
      energyScaleGainUp = userdatahelpers::getUserFloat(cand,"energyScaleGainUp");
      energyScaleGainDown = userdatahelpers::getUserFloat(cand,"energyScaleGainDown");
      energyScaleEtUp = userdatahelpers::getUserFloat(cand,"energyScaleEtUp");
      energyScaleEtDown = userdatahelpers::getUserFloat(cand,"energyScaleEtDown");
      ...
      energySigmaPhiUp = userdatahelpers::getUserFloat(cand,"energySigmaPhiUp");
      energySigmaPhiDown = userdatahelpers::getUserFloat(cand,"energySigmaPhiDown");
      energySigmaRhoUp = userdatahelpers::getUserFloat(cand,"energySigmaRhoUp");
      energySigmaRhoDown = userdatahelpers::getUserFloat(cand,"energySigmaRhoDown");      
    ...
    _daughters_ecalEnergyErrPreCorr.push_back(ecalEnergyErrPreCorr);
    _daughters_ecalEnergyErrPostCorr.push_back(ecalEnergyErrPostCorr);
    _daughters_ecalTrkEnergyPreCorr.push_back(ecalTrkEnergyPreCorr);
    _daughters_ecalTrkEnergyErrPreCorr.push_back(ecalTrkEnergyErrPreCorr);
    ...
    _daughters_energyScaleValue.push_back(energyScaleValue);
    _daughters_energySigmaValue.push_back(energySigmaValue);
    _daughters_energySmearNrSigma.push_back(energySmearNrSigma);
    _daughters_energyScaleUp.push_back(energyScaleUp);
    _daughters_energyScaleDown.push_back(energyScaleDown);
    _daughters_energyScaleStatUp.push_back(energyScaleStatUp);
    _daughters_energyScaleStatDown.push_back(energyScaleStatDown);
    _daughters_energyScaleSystUp.push_back(energyScaleSystUp);
    _daughters_energyScaleSystDown.push_back(energyScaleSystDown);
    _daughters_energyScaleGainUp.push_back(energyScaleGainUp);
    _daughters_energyScaleGainDown.push_back(energyScaleGainDown);
    _daughters_energyScaleEtUp.push_back(energyScaleEtUp);
    _daughters_energyScaleEtDown.push_back(energyScaleEtDown);
    _daughters_energySigmaUp.push_back(energySigmaUp);
    _daughters_energySigmaDown.push_back(energySigmaDown);
    _daughters_energySigmaPhiUp.push_back(energySigmaPhiUp);
    _daughters_energySigmaPhiDown.push_back(energySigmaPhiDown);
    _daughters_energySigmaRhoUp.push_back(energySigmaRhoUp);
    _daughters_energySigmaRhoDown.push_back(energySigmaRhoDown);    
    ...
    _daughters_jetBTagDeepJet.push_back(jetBTagDeepJet);
